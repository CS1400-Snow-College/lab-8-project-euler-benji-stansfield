...
/*Summation of primes problem*/
static long SummationOfPrimes()
{
...
Find the sum of all the primes below two million.");
    ...
    for(int i = 3; i<2000000; i += 2) //this skips even numbers
    {
        if(IsPrime(i))
            sum += i;
    }
...
static bool IsPrime(long num)
{
    ...
    if(num < 2)
        return false;
    for(int i = 3; i <= Math.Sqrt(num); i += 2) //this also skips odd numbers
    {
        if(num % i == 0)
            return false;
    }
